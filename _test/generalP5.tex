...
\newenvironment{specHead}[2]%
 {\vspace{20pt}\hrule\vspace{10pt}%
  ...
  \hspace{-0.75in}{\bfseries\fontsize{16pt}{18pt}\selectfont#2}%
      ...
      \def\TheFullDate{2024-05-28 (revised: 2024-05-28T18:45:06Z)}
\def\TheID{\makeatother }
\def\TheDate{2024-05-28}
...
\begin{longtable}{P{0.5573002754820936\textwidth}P{0.21074380165289255\textwidth}P{0.08195592286501377\textwidth}}
...
\noindent\includegraphics[]{./../Images/nature1.jpg}\tabcellsep Mountain flowers. \tabcellsep north\\
\noindent\includegraphics[]{./../Images/nature2.jpg}\tabcellsep Sunset over a secondary ridge.\tabcellsep north-east\\
\noindent\includegraphics[]{./../Images/nature3.jpg}\tabcellsep Glacier lake at 2100m altitude.\tabcellsep east\end{longtable} \par
  \par 
...
\begin{longtable}{P{0.2805530776092774\textwidth}P{0.5694469223907225\textwidth}}
\tabcellsep \noindent\includegraphics[]{./../Images/portrait.jpg}\\
portrait with a width of 2.5in\tabcellsep \noindent\includegraphics[width=2.5in,]{./../Images/portrait.jpg}\\
portrait with a width of 0.5in\tabcellsep \noindent\includegraphics[width=0.5in,]{./../Images/portrait.jpg}\\
portrait with a scale of .5\tabcellsep \noindent\includegraphics[scale=.5,]{./../Images/portrait.jpg}\\
portrait with a width of 1in\tabcellsep \noindent\includegraphics[width=1in,]{./../Images/portrait.jpg}\\
portrait with a width of 1in and solid green 2pt border\tabcellsep \noindent\includegraphics[width=1in,]{./../Images/portrait.jpg}\\
portrait with a height of 1in\tabcellsep \noindent\includegraphics[height=1in,]{./../Images/portrait.jpg}\\
portrait with a height of 1in and a width of 2in\tabcellsep \noindent\includegraphics[width=2in,height=1in,]{./../Images/portrait.jpg}\\
portrait with a height of 2in and a width of 1in\tabcellsep \noindent\includegraphics[width=1in,height=2in,]{./../Images/portrait.jpg}\\
portrait with a width of 10\%\tabcellsep \noindent\includegraphics[width=0.1\textwidth,]{./../Images/portrait.jpg}\\
portrait with both height \& width set to 10\%\tabcellsep \noindent\includegraphics[width=0.1\textwidth,height=0.1\textheight,]{./../Images/portrait.jpg}\end{longtable} \par
 
\section[{MS catalogue}]{MS catalogue}
\section{Identification}
where is it, repository name, identifier
\section[{Extended prose: MARLEY'S GHOST}]{Extended prose: MARLEY'S GHOST}\label{S1}% image:./../Images/bar.jpg
\par
